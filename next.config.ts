...
const nextConfig: NextConfig = {
  // ฝัง CSS ลงใน HTML แทนการโหลดเป็นไฟล์แยก
  //
  // PageSpeed Insights ชี้ว่าไฟล์ CSS 11 KB บล็อกการแสดงผลอยู่ราว 150-380 ms ทุกหน้า
  // เพราะเบราว์เซอร์ต้องรอโหลดไฟล์นั้นให้เสร็จก่อนจึงจะวาดหน้าได้
  // การฝังลงไปเลยตัดการรอรอบนั้นทิ้ง แลกกับ HTML ที่ใหญ่ขึ้น 11 KB ต่อหน้า
  // ซึ่งเมื่อบีบอัดแล้วเหลือราว 3 KB จึงคุ้มกว่าการเสียเวลารอหนึ่งรอบ
  // โดยเฉพาะบนมือถือที่ LCP อยู่ที่ 2.6 วินาที ห่างจากเกณฑ์เขียว 2.5 วินาทีแค่นิดเดียว
  experimental: {
    inlineCss: true,
  },
  images: {
