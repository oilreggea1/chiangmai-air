...
export function localBusinessSchema() {
  return {
    ...
    taxID: site.taxId,
    description:
      "ช่างแอร์เชียงใหม่ รับล้างแอร์ ซ่อมแอร์ ติดตั้งแอร์ ย้ายแอร์ และล้างเครื่องซักผ้าถึงบ้าน ครอบคลุมสันกำแพง ต้นเปา และอำเภอเมืองเชียงใหม่ แจ้งราคาก่อนเริ่มงาน รับประกันผลงาน ออกใบเสร็จในนามบริษัทได้",
    url: site.url,
