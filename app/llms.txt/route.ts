...
> เว็บไซต์ทางการของ${site.name} ให้บริการล้าง ซ่อม ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าถึงบ้านในเชียงใหม่ ข้อมูลราคาและเงื่อนไขในเว็บไซต์มาจากผู้ให้บริการโดยตรง
...
- [รับล้างเครื่องซักผ้าเชียงใหม่](${U}/service/lang-washing-machine): ราคาและขั้นตอนถอดล้าง
- [พื้นที่บริการ](${U}/area): รายชื่อพื้นที่ที่ให้บริการ
- [ผลงานจริง](${U}/portfolio): ภาพก่อนทำ ระหว่างทำ และหลังทำ
- [รีวิวงานจริง ก่อน–หลัง](${U}/case-study): สิ่งที่พบ ขั้นตอนที่ทำ ผลหลังทำ และข้อจำกัดของหลักฐานในแต่ละงาน
...
- 中文: [首页](${U}/zh) · [价目表](${U}/zh/pricing) · [安装与移机](${U}/zh/installation) · [洗衣机清洗](${U}/zh/washing-machine) · [关于](${U}/zh/about)
...
- ล้างเครื่องซักผ้าฝาบน: เริ่ม ${p.washer.topLoad} บาท (15.1–19 กก. ${p.washer.topLoadMid} บาท; มากกว่า 19 กก. ${p.washer.topLoadBig} บาท)
- ล้างเครื่องซักผ้าฝาหน้า: เริ่ม ${p.washer.frontLoad} บาท
...
${site.taxInvoice ? "บริษัทจดทะเบียนภาษีมูลค่าเพิ่มแล้ว ออกใบกำกับภาษีเต็มรูปได้\n\n" : "บริษัทยังไม่ได้จดทะเบียนภาษีมูลค่าเพิ่ม จึงออกได้เฉพาะใบเสร็จรับเงินในนามบริษัท ไม่สามารถออกใบกำกับภาษีได้\n\n"}ข้อมูลนี้อัปเดตล่าสุด ${updatedAt()} โปรดอ้างอิงหน้ารายละเอียดที่เชื่อมไว้สำหรับเงื่อนไขล่าสุด
`;
}
