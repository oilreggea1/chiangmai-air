...
const faqs = [
  ...
  {
    q: "可以开收据吗？",
    a: "可以。Cher Solutions Co., Ltd. 已登记增值税，可开具泰国增值税发票（ใบกำกับภาษี）和公司抬头收据，餐厅、咖啡店、酒店、民宿和办公室报账都适用。请在上门前把公司名称和税号发给我，完工时一并交付。"
  },
  {
    q: "公寓和出租房可以做吗？",
      ...
      <section className="section" lang="zh-CN">
        <div className="wrap max-w-3xl">
          ...
          <p className="lead mt-3">
            ...
            和机场周边；Hang Dong 县与 San Sai 县（含 Mae Jo 湄州一带）也全部乡都接。此外还有 San Kamphaeng、Saraphi 和 Doi Saket。
          </p>
