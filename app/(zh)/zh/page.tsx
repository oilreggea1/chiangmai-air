...
const servicesZh = [
  {
    ...
    desc: "壁挂机常规清洗每台 500 泰铢，三台以上每台 450 泰铢。深度拆洗 2,000 泰铢，会把风轮和所有可拆部件取下单独清洗消毒。如果您的机器没有异味且定期清洗，我会告诉您常规清洗就够了。",
  },
  {
    icon: IconWrench,
    name: "空调维修",
...
const faqs = [
  ...
  {
    q: "清迈空调清洗多少钱？",
    a: "壁挂机 9,000–18,000 BTU 每台 500 泰铢，三台以上每台 450 泰铢。18,001–38,000 BTU 每台 800 泰铢。深度拆洗每台 2,000 泰铢。所有价格都公开在网站上，中国客户和泰国客户价格完全一样。",
  },
  {
    q: "对中国客人会不会加价？",
  ...
  {
    q: "可以开收据吗？",
    a: "可以开公司抬头的收据，抬头为 Cher Solutions Co., Ltd.，作为付款凭证使用。这里如实告知：公司目前还没有登记增值税，所以暂时无法开具增值税发票（ใบกำกับภาษี）。如果贵司报账必须要增值税发票，请在下单前先告诉我。"
  },
  {
    q: "公寓和出租房可以做吗？",
