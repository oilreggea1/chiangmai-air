...
const description =
  "หาช่างแอร์ใกล้บ้านในเชียงใหม่ เช็คได้ทันทีว่าตำบลของคุณอยู่ในเขตที่ผมไปถึง เมืองเชียงใหม่ทุกตำบล สันกำแพง สารภี หางดงทุกตำบล ดอยสะเก็ด และสันพระเนตร ราคาเดียวกันทุกพื้นที่ ไม่คิดค่าเดินทางเพิ่ม";
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-3xl pt-8 pb-14 text-center">
          ...
          <p className="lead mt-5">
            ผมรับงานในอำเภอเมืองเชียงใหม่ทุกตำบล สันกำแพง สารภี หางดง ดอยสะเก็ด และ ต.สันพระเนตร อ.สันทราย
            รวม {coverage.length} อำเภอ {coverageTotal} ตำบล โดยไม่คิดค่าเดินทางเพิ่ม
            อำเภอเมืองเชียงใหม่และอำเภอหางดงผมรับทุกตำบล ส่วนอำเภออื่นรับเฉพาะตำบลที่อยู่ในระยะให้บริการ
