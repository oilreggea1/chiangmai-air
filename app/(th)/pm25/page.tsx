...
const title = "ล้างแอร์สู้ฝุ่น PM2.5 เชียงใหม่ ก่อนหมอกควัน";
const description =
  `แพ็กเกจรับมือฝุ่น PM2.5 เชียงใหม่ เริ่ม ${p.pm25} บาท ล้างแอร์ถอดชิ้นส่วนและอุดรอยรั่วของห้อง ก่อนฤดูหมอกควัน ก.พ.–เม.ย. ที่คิวแน่นทั้งจังหวัด`;
        ...
        <div className="wrap max-w-3xl">
          ...
          <div className="card mt-6 border-2 border-amber-300 bg-amber-50 p-6 sm:p-7">
            ...
            <p className="mt-3 text-[15px] leading-8 text-ink-soft">
              ...
              ไม่ได้ออกแบบมาเพื่อดักอนุภาคขนาด 2.5 ไมครอน แผ่นกรองที่ติดมากับเครื่องจึงไม่ได้ทำให้ห้องปลอดภัยจาก PM2.5 ด้วยตัวมันเอง
            </p>
          </div>
