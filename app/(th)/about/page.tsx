...
const promises = [
  {
    ...
    detail:
      "ไม่ว่างานขนาดใด ผมแจ้งราคาที่แน่นอนก่อนเริ่มเสมอ หากหน้างานมีค่าใช้จ่ายเพิ่มจากที่ตกลงไว้ ผมจะหยุดและขอความเห็นชอบก่อน",
  },
  {
  ...
  {
    title: "ประเมินตามจริงแม้จะไม่ได้งานซ่อม",
    detail:
      "บางกรณีค่าซ่อมสูงเกินครึ่งของราคาเครื่องใหม่ ผมจะแจ้งให้ทราบว่าไม่คุ้มค่า และเสนอทางเลือกให้พิจารณา",
  },
  {
        ...
        <div className="wrap max-w-3xl">
          ...
          <div className="card mt-6 p-6 sm:p-8">
            ...
            <p className="mt-5 text-[15px] leading-8 text-ink-soft">
              งานทุกชิ้นที่ผมรับ ผมเป็นผู้ลงมือทำเอง
