...
const answers: Answer[] = [
  ...
  {
    q: "ล้างถังเครื่องซักผ้าเชียงใหม่ ราคาเท่าไร?",
  ...
  {
    q: "ช่างเข้าหน้างานได้เร็วแค่ไหน?",
  ...
  },
  {
    ...
    a: "งานล้างแอร์และล้างถังเครื่องซักผ้ารับประกัน 30 วัน งานติดตั้งรับประกัน 1 ปีเมื่อซื้อเครื่องกับโปรเฟรชแคร์ และ 6 เดือนเมื่อลูกค้ามีเครื่องเอง ส่วนงานซ่อมขึ้นกับอะไหล่และจะแจ้งก่อนเริ่มงาน",
    href: "/price",
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-4xl pt-8 pb-14">
          ...
          <p className="lead mt-5 max-w-3xl">
            รวมคำถามที่ลูกค้าสอบถามบ่อยเกี่ยวกับราคา พื้นที่ให้บริการ เงื่อนไข และการรับประกัน
            เพื่อให้คุณเตรียมข้อมูลและเลือกบริการได้สะดวก หากต้องการรายละเอียดเพิ่มเติม สามารถเปิดดูในแต่ละหัวข้อหรือสอบถามช่างอาร์มได้โดยตรงครับ
          </p>
        ...
        <div className="wrap max-w-4xl grid gap-6 md:grid-cols-2">
          <div className="card p-6 sm:p-8">
            ...
            <p className="mt-3 text-[15px] leading-8 text-ink-soft">
              ...
              ช่างตรวจเครื่องจริงและแจ้งยอดก่อนเริ่มงาน ภาพและวิดีโอในเว็บเป็นผลงานจริงของทีม
            </p>
