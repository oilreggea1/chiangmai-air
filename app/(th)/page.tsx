...
/**
 * สร้างหน้าใหม่วันละครั้ง (13 ก.ย. 2569)
 *
 * เดิมหน้าแรกเป็น static ล้วน HTML ที่ Vercel เสิร์ฟจึงค้างตั้งแต่ deploy ครั้งล่าสุด
 * วัดจริงเมื่อ 13 ก.ย. พบว่าอายุแคชอยู่ที่ 13 วัน ทำให้โปร 9.9 ที่หมดเขตไปแล้ว
 * ยังถูกส่งให้ Googlebot อยู่ทุกครั้ง ทั้งที่โค้ดมีชั้นซ่อนฝั่งเบราว์เซอร์ไว้แล้ว
 *
 * ตั้งให้สร้างใหม่วันละครั้ง เนื้อหาที่ผูกกับวันจึงค้างได้ไม่เกินหนึ่งวัน
 * ไม่กระทบความเร็ว เพราะผู้เข้าชมยังได้หน้าจากแคชเหมือนเดิม
 */
        ...
        <div className="wrap relative grid gap-12 pt-12 pb-16 sm:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:pt-20 lg:pb-24">
          <div>
            <p className="eyebrow">
              ...
              ที่ตั้ง ต.สันกำแพง · รับงานเมืองเชียงใหม่ทุกตำบล สันกำแพง สารภี หางดง ดอยสะเก็ด
            </p>
      ...
      <section className="section" id="area">
        <div className="wrap">
          <div className="max-w-2xl">
            ...
            <p className="lead mt-3">
              รับงานอำเภอเมืองเชียงใหม่ทุกตำบล สันกำแพง สารภี หางดง ดอยสะเก็ด และ ต.สันพระเนตร อ.สันทราย
              โดยอำเภอเมืองเชียงใหม่และอำเภอหางดงรับทุกตำบล ส่วนอำเภออื่นรับเฉพาะพื้นที่ในระยะบริการ
