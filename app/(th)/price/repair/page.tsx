...
const faqs = [
  ...
  },
  {
    ...
    a: "เนื่องจากอะไหล่แต่ละยี่ห้อและรุ่นมีราคาต่างกันหลายเท่าครับ คาปาซิเตอร์ของแอร์ธรรมดากับแผงวงจรของอินเวอร์เตอร์อยู่คนละระดับราคา ผมจึงตรวจสภาพจริงก่อนแล้วแจ้งราคาที่แน่นอนให้ทราบก่อนเริ่มงาน",
  },
  {
  ...
  },
  {
    ...
    a: "ขึ้นกับอายุเครื่องและค่าซ่อมครับ หากเครื่องมีอายุเกิน 10 ปี ใช้น้ำยา R22 ซึ่งหาได้ยากขึ้นเรื่อย ๆ และค่าซ่อมสูงเกินครึ่งของราคาเครื่องใหม่ ผมจะแนะนำให้เปลี่ยนเครื่อง พร้อมเสนอทางเลือกให้พิจารณา",
  },
];
      ...
      <section className="section pt-4">
        <div className="wrap max-w-4xl">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-3">
            {[
              { t: "ค่าตรวจเช็ค", d: `ค่าวินิจฉัยหาสาเหตุ ${p.repair.diagnostic} บาท และหักคืนให้จากค่าซ่อมเมื่อตัดสินใจซ่อม` },
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3">
            เลือกอาการที่ตรงกับเครื่องของคุณ เพื่อดูสาเหตุที่เป็นไปได้และข้อที่ตรวจเองได้ก่อนโดยไม่มีค่าใช้จ่าย
          </p>
