...
const faqs = [
  {
    ...
    a: "ปกติผมเข้าหน้างานได้ภายใน 24 ชั่วโมงครับ และเข้าในวันเดียวกันได้หากคิวว่าง ยกเว้นช่วงกุมภาพันธ์ถึงเมษายนที่คิวแน่นทั้งจังหวัด โทรมาถามคิวได้เลย ผมจะบอกตรง ๆ ว่าเข้าได้เร็วที่สุดวันไหนและเวลาไหน ถ้าเข้าไม่ได้จริงผมก็จะบอกว่าไม่ได้ ไม่รับปากไว้ก่อนแล้วเลื่อนทีหลัง",
  },
  {
    q: "วันอาทิตย์รับงานหรือไม่?",
    a: `เวลาทำการปกติคือ${site.daysLabel} ${site.hours} และวันอาทิตย์ผมหยุดครับ แต่ถ้าเป็นเรื่องเร่งด่วนมากจริง ๆ โทรมาได้เลย ผมจะหาคิวให้ ไม่ต้องเกรงใจที่จะโทรถาม เพราะการรู้เร็วว่าได้หรือไม่ได้ ดีกว่ารอทั้งวันแล้วต้องไปหาช่างเจ้าอื่นตอนเย็น`,
  },
  {
  ...
  },
  {
    ...
    a: "ปิดเบรกเกอร์ของแอร์ก่อนครับ โดยเฉพาะถ้ามีกลิ่นไหม้ มีควัน หรือมีน้ำหยดลงจุดที่มีไฟฟ้า อย่าเปิดเครื่องซ้ำเพื่อลองดูอีก เพราะถ้าเป็นปัญหาทางไฟฟ้าการเปิดซ้ำจะทำให้เสียหายลามกว่าเดิม แล้วโทรหรือส่ง LINE มาบอกอาการไว้ได้เลย ผมตอบตอนเช้าและจัดคิวให้เป็นลำดับต้น",
  },
  {
  ...
  },
  {
    ...
    a: "บอกสามอย่างครับ หนึ่งคือยี่ห้อกับรุ่น ถ่ายรูปป้ายที่ตัวเครื่องส่งมาได้เลย สองคืออาการที่เจอและเริ่มเมื่อไร เช่น ไม่เย็นเลย เย็นแล้วตัด มีน้ำหยด หรือมีเสียงผิดปกติ สามคือถ้ามีรหัสขึ้นบนจอหรือมีไฟกระพริบ ถ่ายวิดีโอตั้งแต่เริ่มรอบมาด้วย สามอย่างนี้ช่วยให้ผมเตรียมอะไหล่ให้ตรงและลดโอกาสที่ต้องกลับไปเบิกของเพิ่ม",
  },
];

const points = [
  {
    t: "โทรถามคิวได้ทันที ผมบอกตรง ๆ ว่าเข้าได้เมื่อไร",
    d: "ผมไม่รับปากไว้ก่อนแล้วเลื่อนทีหลัง ถ้าคิวเต็มจริงผมจะบอกว่าเต็ม และบอกว่าเข้าได้เร็วที่สุดวันไหน เพื่อให้คุณตัดสินใจได้ทันทีว่าจะรอหรือหาเจ้าอื่น การรู้เร็วมีค่ากว่าการถูกปลอบไว้ก่อน",
  },
  {
  ...
  },
  {
    ...
    d: "งานที่ต้องเข้าหลังหกโมงเย็นหรือก่อนแปดโมงเช้า ผมรับนัดให้ได้โดยมีค่าบริการเพิ่ม และแจ้งยอดรวมให้ทราบก่อนตกลงนัด ไม่มีการบวกเพิ่มตอนจบงาน",
  },
  {
    t: "วันอาทิตย์หยุด แต่เรื่องเร่งด่วนมากโทรมาได้",
    d: "วันอาทิตย์เป็นวันหยุดของผม แต่ถ้าเป็นเรื่องเร่งด่วนมากจริง ๆ โทรมาได้เลยครับ ผมจะหาคิวให้ ไม่ต้องเกรงใจที่จะโทรถาม",
  },
];
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap pt-8 pb-14 lg:pb-20">
          ...
          <h1 className="mt-5 max-w-3xl text-[1.9rem] leading-[1.3] font-extrabold sm:text-[2.4rem]">
            ช่างแอร์ด่วนเชียงใหม่ โทรถามคิวได้เลย
          </h1>
          <p className="lead mt-5 max-w-3xl">
            ปกติผมเข้าหน้างานได้ภายใน 24 ชั่วโมง และเข้าวันเดียวกันได้หากคิวว่าง
            โทรมาถามได้ทันที ผมจะบอกตรง ๆ ว่าเข้าได้เร็วที่สุดวันไหน
            ถ้าเข้าไม่ได้ผมก็จะบอกว่าไม่ได้ เพื่อให้คุณหาทางอื่นได้ทันโดยไม่ต้องรอเก้อ
          </p>
      ...
      <CtaBand
        ...
        subtitle={`โทรถามคิวได้ทันที ผมบอกตรง ๆ ว่าเข้าได้เร็วที่สุดวันไหน ค่าตรวจเช็ค ${p.repair.diagnostic} บาท ซึ่งหักคืนให้ถ้าตกลงซ่อม และแจ้งราคาครบก่อนเริ่มงานเสมอ`}
      />
    </>
  );
}
