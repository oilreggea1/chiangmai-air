...
const faqs = [
  ...
  },
  {
    ...
    a: `${site.afterHours} ผมจะบอกยอดรวมให้ทราบก่อนตกลงนัดเสมอ`,
  },
  {
...
const points = [
  ...
  },
  {
    ...
    d: "งานที่ต้องเข้าหลัง 18:00 น. หรือก่อน 08:00 น. ผมรับนัดให้ได้โดยมีค่าบริการเพิ่ม และแจ้งยอดรวมให้ทราบก่อนตกลงนัด",
  },
  {
