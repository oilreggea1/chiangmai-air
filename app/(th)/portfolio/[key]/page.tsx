...
export async function generateMetadata({
  ...
  if (!c) return {};
  // เลิกต่อท้ายชื่อร้านแล้ว จึงมีที่พอให้ใส่คำว่าเชียงใหม่ได้ครบทุกหมวด
  // ซึ่งเป็นคำที่คนค้นจริง ต่างจากชื่อร้านที่แทบไม่มีใครค้น
  const title = `${c.label} เชียงใหม่ ผลงานจริง ${c.photos.length} ภาพ`;
