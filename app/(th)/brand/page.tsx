  ...
  return (
    <>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <p className="mt-10 max-w-3xl text-sm leading-7 text-ink-soft">
            ยี่ห้ออื่นที่ไม่ได้ระบุไว้ ผมรับงานเช่นกัน โทรสอบถามได้ครับ
          </p>
        </div>
      </section>
      ...
      <CtaBand
        ...
        subtitle="ถ่ายรูปป้ายรุ่นที่ตัวเครื่องส่งมาทาง LINE ได้ครับ ป้ายนี้บอกทั้งรุ่นและขนาด BTU ผมดูให้แล้วแจ้งราคากับเวลาที่ต้องใช้ให้ทราบก่อนนัด"
      />
    </>
  );
}
