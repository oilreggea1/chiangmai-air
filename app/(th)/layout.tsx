...
export const metadata: Metadata = {
  ...
  description:
    `ช่างแอร์เชียงใหม่ โทร 065-365-7673 ล้างแอร์ ${p.wash.std} บาท 3 เครื่องขึ้นไปเครื่องละ ${p.wash.stdBulk} บาท ซ่อม ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าถึงบ้าน แจ้งราคาก่อนเริ่มงาน`,
  keywords: [
