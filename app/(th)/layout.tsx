...
export const metadata: Metadata = {
  ...
  description:
    "ช่างแอร์เชียงใหม่ โทร 065-365-7673 ล้างแอร์ 500 บาท 3 เครื่องขึ้นไปเครื่องละ 450 บาท ซ่อม ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าถึงบ้าน แจ้งราคาก่อนเริ่มงาน",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "ล้างแอร์ 500 บาท 3 เครื่องขึ้นไปเครื่องละ 450 บาท ซ่อมแอร์ ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าทั่วเชียงใหม่ แจ้งราคาชัดเจนก่อนเริ่มงาน",
  },
  twitter: {
    card: "summary_large_image",
    title: "ช่างแอร์เชียงใหม่ ล้างแอร์ ซ่อมแอร์ ถึงบ้าน",
    description: "ล้างแอร์ 500 บาท · 3 เครื่องขึ้นไป เครื่องละ 450 บาท ทั่วเชียงใหม่",
  },
};
