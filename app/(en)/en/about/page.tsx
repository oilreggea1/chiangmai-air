...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/about",
    languages: { "th-TH": "/about", "en-US": "/en/about", "x-default": "/about" },
  },
...
const facts = [
  ...
  { k: "Receipts", v: "Issued in the company name on request. The company is not VAT registered, so a full VAT tax invoice is not available." },
];
