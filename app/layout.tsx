...
export const metadata: Metadata = {
  ...
  description:
    "ช่างแอร์เชียงใหม่ ล้างแอร์เริ่ม 550 บาท ซ่อมแอร์ด่วน 24 ชม. ติดตั้งและย้ายแอร์ พร้อมบริการล้างถังเครื่องซักผ้าถึงบ้าน ครอบคลุมสันกำแพง ต้นเปา และอำเภอเมืองเชียงใหม่ แจ้งราคาก่อนเริ่มงาน รับประกันผลงาน โทร 065-365-7673",
  ...
  keywords: [
    ...
    "ช่างแอร์ดอยสะเก็ด", "ช่างแอร์สารภี", "ช่างแอร์สันทราย", "ช่างแอร์แม่ออน",
  ...
  openGraph: {
    ...
    description:
      "ล้างแอร์เริ่ม 550 บาท ซ่อมแอร์ด่วนภายใน 24 ชม. ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าทั่วเชียงใหม่ แจ้งราคาชัดเจนก่อนเริ่มงาน",
  },
  twitter: {
