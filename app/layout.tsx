...
export const metadata: Metadata = {
  ...
  description:
    "ช่างแอร์เชียงใหม่ ล้างแอร์เริ่ม 600 บาท ซ่อมแอร์ด่วน 24 ชม. ติดตั้งและย้ายแอร์ พร้อมบริการล้างถังเครื่องซักผ้าถึงบ้าน ครอบคลุมสันกำแพง ต้นเปา และอำเภอเมืองเชียงใหม่ แจ้งราคาก่อนเริ่มงาน รับประกันผลงาน โทร 065-365-7673",
  ...
  openGraph: {
    ...
    description:
      "ล้างแอร์เริ่ม 600 บาท ซ่อมแอร์ด่วนภายใน 24 ชม. ติดตั้ง ย้ายแอร์ และล้างเครื่องซักผ้าทั่วเชียงใหม่ แจ้งราคาชัดเจนก่อนเริ่มงาน",
  },
  twitter: {
    card: "summary_large_image",
    title: "ช่างแอร์เชียงใหม่ ล้างแอร์ ซ่อมแอร์ ถึงบ้าน",
    description: "ล้างแอร์เริ่ม 600 บาท ซ่อมแอร์ด่วน 24 ชม. ทั่วเชียงใหม่",
  },
  robots: {
    index: true,
    follow: true,
