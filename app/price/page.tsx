      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3 text-center">
            ราคาที่ต่างกันมาจากขั้นตอนการทำงานที่ต่างกันจริง ไม่ใช่เพียงชื่อแพ็กเกจ
          </p>
      ...
      <section className="section">
        <div className="wrap max-w-3xl">
          ...
          <ul className="mt-6 space-y-4">
            {[
              "ราคาที่แจ้งเป็นราคาสำหรับแอร์ติดผนัง (Wall Type) กรณีแอร์แขวน แอร์ตู้ตั้ง หรือแอร์สี่ทิศทาง กรุณาแจ้งล่วงหน้าเพื่อประเมินราคาแยก",
              ...
              "ค่าติดตั้งครอบคลุมอุปกรณ์ระยะมาตรฐาน หากต้องเดินท่อยาวกว่านั้น จะแจ้งค่าส่วนเกินก่อนเริ่มงาน",
