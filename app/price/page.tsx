    ...
    <>
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-3xl pt-8 pb-14 text-center">
          ...
          <p className="lead mt-5">
            เราแสดงราคาทุกรายการไว้ตรงนี้ให้ดูก่อนตัดสินใจ ราคาที่เห็นคือราคาที่จ่ายจริง
            ไม่มีค่าเดินทางเพิ่มในเขตให้บริการ หากหน้างานมีค่าใช้จ่ายเพิ่มเราแจ้งก่อนลงมือเสมอ
          </p>
        </section>
      </div>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3 text-center">
            ราคาต่างกันเพราะขั้นตอนต่างกันจริง ไม่ใช่แค่ชื่อแพ็กเกจ
          </p>
      ...
      <section className="section">
        <div className="wrap max-w-3xl">
          <h2 className="h2">เงื่อนไขที่ควรรู้ก่อนเรียกช่าง</h2>
          <ul className="mt-6 space-y-4">
            {[
              ...
              "ค่าตรวจเช็ค 500 บาท จะหักออกจากค่าซ่อมให้ หากลูกค้าตัดสินใจซ่อมกับเรา",
              "เติมน้ำยาคิดตามจริงปอนด์ละ 25 บาท เราตรวจให้ดูต่อหน้าและไม่เติมถ้าไม่ขาด",
              "ค่าติดตั้งครอบคลุมอุปกรณ์ระยะมาตรฐาน หากต้องเดินท่อยาวกว่าปกติจะแจ้งค่าส่วนเกินก่อนทำงาน",
              "รับประกันงานล้าง 30 วัน (ธรรมดา) และ 60 วัน (พรีเมี่ยม) งานติดตั้งรับประกันสูงสุด 1 ปี",
              "ชำระเงินหลังงานเสร็จและลูกค้าตรวจรับเรียบร้อยแล้ว รับทั้งเงินสดและโอนธนาคาร",
            ].map((t) => (
      ...
      <FaqList items={faqs} />
      <CtaBand
        title="อยากรู้ราคาที่แน่นอนของหน้างานคุณ?"
        subtitle="ทักมาบอกจำนวนเครื่อง ขนาด BTU หรืออาการเสีย เราประเมินให้ฟรีทันที ไม่มีค่าใช้จ่าย"
      />
    </>
  );
}
