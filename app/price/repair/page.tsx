...
const description =
  "ราคาซ่อมแอร์เชียงใหม่แบบเปิดเผย ค่าตรวจเช็ค 500 บาทหักคืนให้เมื่อตัดสินใจซ่อม เติมน้ำยา R32 และ R410A ปอนด์ละ 25 บาท พร้อมคู่มืออาการเสียแต่ละแบบว่าเกิดจากอะไร โทร 065-365-7673";
...
const faqs = [
  {
    ...
    a: "ชำระเฉพาะกรณีที่ตรวจแล้วไม่ได้ดำเนินการซ่อมครับ หากตัดสินใจซ่อม ผมหักคืนให้ทั้งจำนวนจากค่าซ่อม",
  },
  {
    q: "ทำไมไม่ลงราคาอะไหล่ทุกตัวไว้เลย",
    a: "เนื่องจากอะไหล่แต่ละยี่ห้อและรุ่นมีราคาต่างกันหลายเท่าครับ คาปาซิเตอร์ของแอร์ธรรมดากับแผงวงจรของอินเวอร์เตอร์อยู่คนละระดับราคา ผมจึงตรวจสภาพจริงก่อนแล้วแจ้งราคาที่แน่นอน ซึ่งตรงกว่าการระบุตัวเลขต่ำไว้แล้วเรียกเก็บเพิ่มภายหลัง",
  },
  {
    q: "น้ำยาแอร์ขาด คิดยังไง",
    a: "ผมตรวจวัดให้โดยไม่คิดค่าใช้จ่ายครับ หากพร่องจริงคิดตามจริงปอนด์ละ 25 บาท ทั้ง R32 และ R410A แต่หากไม่พร่องจะแจ้งให้ทราบและไม่เติม เนื่องจากการเติมเกินทำให้แรงดันสูงผิดปกติและลดอายุคอมเพรสเซอร์",
  },
  {
    ...
    <>
      ...
      <section className="section pt-4">
        <div className="wrap max-w-4xl">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-3">
            {[
              { t: "ค่าตรวจเช็ค", d: "ค่าวินิจฉัยหาสาเหตุ 500 บาท และหักคืนให้จากค่าซ่อมเมื่อตัดสินใจซ่อม" },
          ...
          <div className="card mt-8 border-2 border-amber-300 bg-amber-50 p-5 sm:p-6">
            ...
            <p className="mt-2.5 text-[15px] leading-8 text-ink-soft">
              ตัวเลขด้านล่างเป็น <strong className="text-ink">ราคารวมค่าแรงและค่าอะไหล่แล้ว</strong>{" "}
              โดยระบุเป็นช่วงเนื่องจากอะไหล่แต่ละยี่ห้อและรุ่นมีราคาต่างกันจริง
              ผมตรวจสภาพเครื่องให้เห็นก่อน แล้วแจ้งราคาที่แน่นอนให้ยืนยันก่อนเริ่มงานทุกครั้ง
              หากไม่ประสงค์จะซ่อม ชำระเพียงค่าตรวจเช็คและจบได้ทันที
            </p>
          </div>
          ...
          <div className="card mt-6 border-2 border-mint/40 bg-mint/6 p-6">
            ...
            <p className="mt-2.5 text-[15px] leading-8 text-ink-soft">
              ช่องที่ขีด (–) หมายถึงอะไหล่ที่เครื่องประเภทนั้นไม่มี ไม่ใช่ราคาที่ไม่เปิดเผย
              แอร์อินเวอร์เตอร์ไม่มีคาปาซิเตอร์คอมเพรสเซอร์และไม่มีแมกเนติก
              เพราะใช้แผงวงจรควบคุมความเร็วคอมเพรสเซอร์แทน
              หากได้รับข้อเสนอให้เปลี่ยนคาปาซิเตอร์คอมเพรสเซอร์กับแอร์อินเวอร์เตอร์ ควรสอบถามรายละเอียดเพิ่มเติมก่อนตัดสินใจ
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap max-w-3xl">
          ...
          <p className="lead mt-3">
            คำถามชุดนี้ใช้ได้กับผู้ให้บริการรายใด ไม่จำเป็นต้องเป็นผม
