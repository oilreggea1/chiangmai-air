...
const description =
  "ราคาซ่อมแอร์เชียงใหม่แบบเปิดเผย ค่าตรวจเช็ค 500 บาทหักคืนให้ถ้าซ่อมกับผม เติมน้ำยา R32 และ R410A ปอนด์ละ 25 บาท พร้อมคู่มืออาการเสียแต่ละแบบว่าเกิดจากอะไร โทร 065-365-7673";
...
const faqs = [
  {
    ...
    a: "จ่ายเฉพาะกรณีที่ตรวจแล้วไม่ได้ซ่อมกับผมครับ ถ้าตัดสินใจซ่อม ผมหักคืนให้ทั้งจำนวน เท่ากับไม่ได้เสียเพิ่ม",
  },
  {
    q: "ทำไมไม่ลงราคาอะไหล่ทุกตัวไว้เลย",
    a: "เพราะอะไหล่ต่างยี่ห้อต่างรุ่นราคาห่างกันหลายเท่าครับ คาปาซิเตอร์ของแอร์ธรรมดากับแผงวงจรของอินเวอร์เตอร์คนละเรื่องกันเลย ผมเลยตรวจให้เห็นของจริงก่อนแล้วบอกราคาที่แน่นอน ดีกว่าลงตัวเลขสวย ๆ ไว้แล้วมาบวกเพิ่มทีหลัง",
  },
  {
    q: "น้ำยาแอร์ขาด คิดยังไง",
    a: "ผมวัดให้ฟรีครับ ถ้าขาดจริงคิดตามจริงปอนด์ละ 25 บาท ทั้ง R32 และ R410A แต่ถ้าไม่ขาดผมไม่เติม เพราะเติมเกินทำให้แรงดันสูงผิดปกติแล้วคอมพังเร็วขึ้น",
  },
  {
    q: "ถ้าน้ำยารั่ว เติมอย่างเดียวพอไหม",
    a: "ไม่พอครับ น้ำยาแอร์เป็นระบบปิด ถ้ามันพร่องแปลว่ามีรอยรั่ว การเติมโดยไม่หารอยรั่วคือการละลายเงินทิ้ง อีกไม่กี่เดือนก็ขาดอีก ผมจะหาจุดรั่วให้เจอก่อนแล้วบอกค่าซ่อมให้ทราบ",
  },
  {
    q: "ซ่อมแล้วมีรับประกันไหม",
    a: "มีครับ ระยะรับประกันขึ้นกับประเภทงานและอะไหล่ที่เปลี่ยน ผมบอกให้ทราบพร้อมราคาก่อนเริ่มงานเสมอ ถ้าอาการเดิมกลับมาในระยะนั้น ผมกลับไปดูให้ฟรี",
  },
  {
    q: "ซ่อมแอร์เก่ากับซื้อใหม่ อันไหนคุ้มกว่า",
    a: "ขึ้นกับอายุเครื่องและค่าซ่อมครับ ถ้าเครื่องเกิน 10 ปี ใช้ R22 ที่หายากขึ้นเรื่อย ๆ และค่าซ่อมเกินครึ่งของราคาเครื่องใหม่ ผมจะแนะนำให้เปลี่ยน ผมบอกตรง ๆ ทั้งที่การรับซ่อมทำให้ผมได้เงินมากกว่า",
  },
];
    ...
    <>
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-3xl pt-8 pb-14 text-center">
          ...
          <p className="lead mt-5">
            เวลาแอร์เสีย สิ่งที่คนอยากรู้ที่สุดคือ &ldquo;จะโดนเท่าไหร่&rdquo; ผมเข้าใจดีครับ
            แต่เว็บร้านแอร์ส่วนใหญ่ให้โทรถามอย่างเดียว ผมเลยเปิดโครงสร้างค่าใช้จ่ายทั้งหมด
            ให้คุณดูก่อนตัดสินใจโทร
          </p>
        </section>
      </div>
      ...
      <section className="section pt-4">
        <div className="wrap max-w-4xl">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-3">
            {[
              { t: "ค่าตรวจเช็ค", d: "ค่าวินิจฉัยหาสาเหตุจริง 500 บาท และผมหักคืนให้ถ้าซ่อมกับผม" },
              { t: "ค่าแรงซ่อม", d: "ขึ้นกับความยากของงาน เช่น เปลี่ยนคาปาซิเตอร์ง่ายกว่าเชื่อมท่อรั่วมาก" },
              { t: "ค่าอะไหล่", d: "ตามจริงของแต่ละยี่ห้อและรุ่น ผมให้ดูของเก่าที่ถอดออกมาทุกครั้ง" },
            ].map((x) => (
          ...
          <div className="card mt-8 border-2 border-amber-300 bg-amber-50 p-5 sm:p-6">
            ...
            <p className="mt-2.5 text-[15px] leading-8 text-ink-soft">
              ตัวเลขด้านล่างเป็น <strong className="text-ink">ราคารวมค่าแรงกับค่าอะไหล่แล้ว</strong>{" "}
              ที่ผมลงเป็นช่วง เพราะอะไหล่ต่างยี่ห้อต่างรุ่นราคาไม่เท่ากันจริง ๆ ไม่ใช่ผมกั๊ก
              ผมตรวจให้เห็นของจริงก่อน แล้วบอกราคาที่แน่นอนให้คุณยืนยันก่อนลงมือทุกครั้ง
              ถ้าไม่โอเคกับราคา จ่ายแค่ค่าตรวจเช็คแล้วจบได้เลยครับ ผมไม่กดดัน
            </p>
          </div>
          ...
          <div className="card mt-6 border-2 border-mint/40 bg-mint/6 p-6">
            ...
            <p className="mt-2.5 text-[15px] leading-8 text-ink-soft">
              ช่องที่ขีด (–) ไม่ใช่ราคาที่ผมไม่บอก แต่คืออะไหล่ที่เครื่องแบบนั้นไม่มีจริง ๆ
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3">
            กดดูอาการที่ตรงกับแอร์ของคุณครับ ผมแจกแจงสาเหตุที่เป็นไปได้ไว้ให้หมด
      ...
      <section className="section">
        <div className="wrap max-w-3xl">
          ...
          <p className="lead mt-3">
            ถามครบ 6 ข้อนี้กับช่างเจ้าไหนก็ได้ครับ ไม่จำเป็นต้องเป็นผม
            ช่างที่ทำงานตรงไปตรงมาจะตอบได้หมดโดยไม่ลังเล
          </p>
      ...
      <CtaBand
        ...
        subtitle="ถ่ายคลิปตอนเปิดแอร์ส่งมาทาง LINE ได้เลยครับ หลายเคสผมดูออกตั้งแต่ยังไม่ถึงหน้างาน และบอกช่วงราคาให้คร่าว ๆ ได้ก่อน"
      />
    </>
  );
}
