        ...
        <section className="wrap grid gap-10 pt-8 pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pb-20">
          <div>
            ...
            <p className="lead mt-5">
              ...
              เป้าหมายของผมไม่ใช่การเป็นผู้ให้บริการที่ใหญ่ที่สุด แต่เป็นผู้ให้บริการที่ลูกค้ามั่นใจพอจะแนะนำต่อได้
            </p>
        ...
        <div className="wrap max-w-3xl">
          ...
          <div className="card mt-6 p-6 sm:p-8">
            ...
            <p className="mt-5 text-[15px] leading-8 text-ink-soft">
              งานเกือบทั้งหมดที่ปรากฏในหน้าผลงาน ผมเป็นผู้ลงมือทำเอง
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3">
            ทั้งหกข้อนี้คือเกณฑ์ที่ผมใช้ตัดสินใจจริงขณะปฏิบัติงาน
