...
const faqs = [
  ...
  },
  {
    ...
    a: "รับครับ ทั้งคาเฟ่ โคเวิร์กกิ้งสเปซ โรงแรมขนาดเล็ก โฮสเทล และห้องพักให้เช่า ในช่วงฤดูหมอกควันคุณภาพอากาศภายในเป็นปัจจัยที่ลูกค้าใช้เลือกสถานที่ และเราออกใบกำกับภาษีให้ได้ตามปกติ",
  },
];
        ...
        <section className="wrap relative grid gap-10 pt-8 pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pb-20">
          <div>
            ...
            <p className="lead mt-5">
              ฤดูหมอกควันส่งผลต่อระบบทางเดินหายใจโดยตรง และยังทำให้แอร์ในบ้านอุดตันเร็วกว่าปกติหลายเท่า
              เมื่อถึงเดือนเมษายนซึ่งเป็นช่วงที่ร้อนที่สุด เครื่องที่อุดตันจะทำความเย็นได้ไม่เพียงพอ
              ขณะที่คิวช่างทั้งจังหวัดก็เต็มจนต้องรอเป็นสัปดาห์
            </p>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-3xl">
          ...
          <p className="mt-6 text-[15px] leading-8 text-ink-soft sm:text-base sm:leading-9">
            ...
            คู่มือห้องปลอดฝุ่นของ สสส. เองก็ระบุขั้นตอนการเปิดเครื่องปรับอากาศไว้ด้วย
