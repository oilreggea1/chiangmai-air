...
const faqs = [
  {
    ...
    a: "ไม่ได้ครับ ผมพูดตรง ๆ เลย แผ่นกรองที่ติดมากับแอร์ดักได้แค่ฝุ่นหยาบ แต่แอร์ยังจำเป็นอยู่ เพราะมันทำให้คุณปิดห้องได้สนิท ซึ่งคือการตัดทางเข้าหลักของฝุ่น ถ้าจะกรอง PM2.5 จริงต้องมีเครื่องฟอก HEPA ด้วย",
  },
  {
    q: "ควรล้างแอร์ตอนไหนถึงจะทันหน้าเผา",
    a: "ผมแนะนำมกราคมถึงต้นกุมภาพันธ์ครับ จะได้เข้าฤดูด้วยคอยล์สะอาด และเป็นช่วงที่คิวผมยังว่าง ถ้ารอถึงเมษายน คิวแน่นทุกร้านในเชียงใหม่จริง ๆ",
  },
  {
    q: "ช่วงฝุ่นควรล้างแผ่นกรองบ่อยแค่ไหน",
    a: "ช่วงกุมภาพันธ์ถึงเมษายน ถอดแผ่นกรองมาล้างเองทุก 2–4 สัปดาห์ได้เลยครับ อันนี้ทำเองได้ ไม่ต้องเรียกผม ล้างด้วยน้ำสะอาดแล้วตากให้แห้งสนิทก่อนใส่กลับ",
  },
  {
    q: "ติดแผ่นกรอง PM2.5 เพิ่มในแอร์เองได้ไหม",
    a: "อย่าแปะเองครับ ผมเจอเคสแบบนี้มาแล้ว แผ่นกรองละเอียดเพิ่มแรงต้านลม ทำให้ลมออกน้อยลงจนคอยล์เป็นน้ำแข็งและมอเตอร์ทำงานหนักจนเสียเร็ว ให้ผมดูก่อนว่ารุ่นของคุณรับได้แค่ไหนดีกว่า",
  },
  {
    q: "แอร์มีกลิ่นอับตอนหน้าเผา แปลว่าอะไร",
    a: "แปลว่าเขม่าที่เกาะบนคอยล์เจอความชื้นจนขึ้นราแล้วครับ เคสนี้ล้างแบบฉีดผ่านไม่หาย ต้องถอดใบพัดกรงกระรอกออกมาล้างแยก ซึ่งก็คือแพ็กเกจถอดล้าง",
  },
  {
    q: "รับงานคาเฟ่ โรงแรม หรือที่พักช่วงหน้าเผาไหม",
    a: "รับครับ ทั้งคาเฟ่ โคเวิร์กกิ้ง โรงแรมเล็ก โฮสเทล และห้องพักให้เช่า ช่วงหน้าเผาลูกค้าเลือกร้านและที่พักจากคุณภาพอากาศจริง ๆ ผมออกใบกำกับภาษีให้ได้ตามปกติ",
  },
];
  ...
  return (
    <>
        ...
        <section className="wrap relative grid gap-10 pt-8 pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pb-20">
          <div>
            ...
            <p className="lead mt-5">
              หน้าเผาไม่ได้ทำร้ายแค่ปอดคุณครับ แต่ทำให้แอร์ในบ้านตันเร็วกว่าปกติหลายเท่าด้วย
              พอถึงเมษายนที่ร้อนที่สุด แอร์ที่ตันแล้วจะเย็นไม่ไหว
              แล้วคิวช่างทั้งเมืองก็แน่นจนรอกันเป็นสัปดาห์
            </p>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-3xl">
          <h2 className="h2">เรื่องที่ผมอยากบอกตรง ๆ</h2>
          <div className="card mt-6 border-2 border-amber-300 bg-amber-50 p-6 sm:p-7">
            ...
            <p className="mt-3 text-[15px] leading-8 text-ink-soft">
              ...
              ไม่ได้ออกแบบมาดักอนุภาค 2.5 ไมครอน ถ้าใครบอกคุณว่าเปิดแอร์แล้วปลอดภัยจาก PM2.5 อัตโนมัติ คนนั้นเข้าใจผิดครับ
            </p>
          </div>

          <p className="mt-6 text-[15px] leading-8 text-ink-soft sm:text-base sm:leading-9">
            แต่แอร์ยังจำเป็นมากครับ เพราะการเปิดแอร์บังคับให้คุณปิดประตูหน้าต่าง
            ซึ่งคือการตัดทางเข้าหลักของฝุ่นจากข้างนอก
            คู่มือห้องปลอดฝุ่นของ สสส. เองก็มีขั้นตอนเปิดเครื่องปรับอากาศอยู่
            เพราะฉะนั้นอย่าเลือกอย่างใดอย่างหนึ่ง ต้องทำครบทั้งสามอย่าง
          </p>
      ...
      <section className="section">
        <div className="wrap max-w-4xl">
          ...
          <p className="lead mt-3">
            อย่ายึดตัวเลข &ldquo;ทุก 6 เดือน&rdquo; แบบตายตัวครับ จัดรอบตามฤดูจริงของเชียงใหม่ได้ผลกว่าเยอะ
          </p>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-4xl">
          <h2 className="h2">ผมช่วยอะไรคุณได้บ้างช่วงนี้</h2>
          ...
          <div className="card mt-5 overflow-hidden">
            <div className="bg-gradient-to-br from-brand-700 to-brand-600 px-6 py-7 sm:px-8">
              <p className="text-sm font-semibold text-brand-100">งานที่ผมทำให้ได้ทั้งชุด</p>
              ...
              <p className="mt-3 max-w-2xl text-[15px] leading-8 text-brand-100">
                ล้างแอร์อย่างเดียวยังไม่พอครับ ถ้าห้องยังมีรอยรั่วให้ฝุ่นเข้าได้อยู่
                ชุดนี้ผมจัดการให้ทั้งตัวแอร์และตัวห้องไปพร้อมกัน
              </p>
            </div>
            ...
            <div className="p-6 sm:p-8">
              <ul className="grid gap-3.5 sm:grid-cols-2">
                {[
                  ...
                  "ผมดูให้ว่าแอร์รุ่นของคุณรับแผ่นกรองละเอียดได้แค่ไหนโดยไม่ทำให้เครื่องพัง",
              ...
              <p className="mt-6 text-sm leading-7 text-ink-soft">
                ราคาเริ่มต้นครอบคลุมห้องมาตรฐาน 1 ห้องพร้อมแอร์ 1 เครื่องครับ
                ถ้าห้องใหญ่กว่าปกติ มีแอร์หลายเครื่อง หรือรอยรั่วต้องแก้เยอะเป็นพิเศษ
                ผมบอกค่าใช้จ่ายเพิ่มให้ทราบก่อนเริ่มงานเสมอ
              </p>
      ...
      <section className="section">
        <div className="wrap">
          <h2 className="h2">อ่านเพิ่มก่อนตัดสินใจได้ครับ</h2>
      ...
      <section className="section pt-0">
        <div className="wrap">
          <p className="text-sm leading-7 text-ink-soft">
            ผมรับจองคิวล้างแอร์ก่อนหน้าเผาทุกพื้นที่:{" "}
            {areas.map((a, i) => (
              <span key={a.slug}>
                {i > 0 && " · "}
      ...
      <CtaBand
        ...
        subtitle="มกราคมถึงต้นกุมภาพันธ์คือช่วงที่ดีที่สุดครับ คิวผมยังว่าง และคุณจะเข้าฤดูฝุ่นด้วยแอร์ที่สะอาดเต็มประสิทธิภาพ"
      />
    </>
  );
}
