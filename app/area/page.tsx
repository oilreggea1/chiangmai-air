      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-3xl pt-8 pb-14 text-center">
          ...
          <p className="lead mt-5">
            เราวิ่งงานครอบคลุมทั้งฝั่งสันกำแพงและอำเภอเมืองเชียงใหม่
            เลือกพื้นที่ของคุณเพื่อดูรายละเอียด ราคา และเวลาเข้างานของโซนนั้น
          </p>
        </section>
      </div>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-3xl">
          ...
          <p className="lead mt-4">
            รายการด้านบนคือโซนที่เรารับงานบ่อยที่สุด แต่เรารับงานทั่วจังหวัดเชียงใหม่
            หากพื้นที่ของคุณอยู่นอกรายการ ทักมาถามได้เลย เราจะแจ้งตรง ๆ ว่าไปได้หรือไม่
            และถ้ามีค่าเดินทางเพิ่มจะบอกให้ทราบก่อนตกลงงานเสมอ
          </p>

          <h3 className="mt-10 text-lg font-bold">บริการที่รับทุกพื้นที่</h3>
