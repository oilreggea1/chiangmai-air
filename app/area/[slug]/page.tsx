...
export default async function AreaPage({ params }: Props) {
  ...
  const areaFaqs = [
    {
      ...
      a: `รับครับ ${a.note} ผมวิ่งงานโซนนี้เป็นประจำ เลยคุ้นเส้นทางและเข้าถึงหน้างานได้เร็ว`,
    },
    {
      q: `เรียกช่างแอร์${a.name} กี่วันได้คิว?`,
      a: "ปกติผมเข้าหน้างานได้ภายใน 24 ชั่วโมงครับ ถ้าคิวว่างผมไปวันเดียวกันเลย โทรหรือทัก LINE มาเช็คคิวก่อนได้",
    },
    {
      q: `มีค่าเดินทางเพิ่มไหมถ้าอยู่${a.name}?`,
      a: `ไม่มีครับ ${a.full} อยู่ในเขตที่ผมวิ่งงานปกติ ราคาที่ลงไว้คือราคาที่จ่ายจริง`,
    },
    {
      q: "รับล้างแอร์คอนโดและหอพักในโซนนี้ไหม?",
      a: "รับครับ ทั้งบ้าน คอนโด หอพัก ร้านกาแฟ ร้านอาหาร และออฟฟิศ ถ้าล้างหลายเครื่องผมมีราคาพิเศษให้",
    },
  ];
  ...
  return (
    <>
        ...
        <section className="wrap grid gap-10 pt-8 pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pb-20">
          <div>
            ...
            <p className="lead mt-5">
              {a.note} ผมรับล้างแอร์ ซ่อมแอร์ ติดตั้ง และย้ายแอร์ใน{a.full}{" "}
              บอกราคาก่อนลงมือ และไม่บวกค่าเดินทางเพิ่มครับ
            </p>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <p className="lead mt-3 max-w-2xl">
            ทุกงานด้านล่างนี้ผมรับใน{a.full} ราคาเดียวกับพื้นที่อื่น ไม่บวกค่าเดินทางครับ
          </p>
      ...
      <section className="section bg-sand">
        <div className="wrap max-w-3xl">
          ...
          <div className="mt-5 space-y-5 text-[15px] leading-8 text-ink-soft sm:text-base sm:leading-9">
            ...
            <p>
              สิ่งที่ลูกค้าโซนนี้พูดถึงบ่อยที่สุดคือ{" "}
              <strong className="text-ink">การบอกราคาก่อนลงมือทุกครั้ง</strong>{" "}
              ผมตรวจให้ดูต่อหน้า อธิบายสาเหตุจริง และไม่เติมน้ำยาถ้ามันไม่ได้ขาด
              เพราะเติมเกินทำให้กินไฟขึ้นและคอมพังเร็วกว่าเดิม
            </p>
            <p>
              งานล้างทุกครั้งผมปูผ้าใบคลุมหนา 2 ชั้นก่อนเริ่ม และเก็บกวาดให้เรียบร้อยก่อนกลับ
              รับประกัน 30–60 วันตามแพ็กเกจที่เลือก ถ้ามีปัญหาน้ำหยดหรือแอร์ไม่เย็นในระยะนั้น
              ผมกลับไปดูให้ฟรีครับ
            </p>
          </div>
      ...
      <section className="section">
        <div className="wrap">
          <h2 className="h2">พื้นที่ใกล้เคียงที่ผมรับงาน</h2>
      ...
      <CtaBand
        ...
        subtitle={`ผมอยู่ไม่ไกลจาก${a.full} ทักมาเช็คคิวได้เลยครับ เข้าหน้างานได้ภายใน 24 ชม.`}
      />
    </>
  );
}
