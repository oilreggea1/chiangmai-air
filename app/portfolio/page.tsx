...
export default function Portfolio() {
  return (
    <>
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white">
        ...
        <section className="wrap max-w-3xl pt-8 pb-14 text-center">
          ...
          <p className="lead mt-5">
            ทุกรูปถ่ายจากหน้างานจริงครับ ทั้งงานถอดล้าง งานซ่อม งานติดตั้ง และงานย้ายแอร์
            คุณจะเห็นทั้งการปูผ้าใบและสภาพชิ้นส่วนตอนถอดออกมา ผมไม่ได้เลือกเฉพาะรูปสวย
          </p>
        </section>
      </div>
      ...
      <CtaBand
        title="อยากให้แอร์ที่บ้านคุณเป็นแบบนี้บ้างไหมครับ"
        subtitle="ทักมาจองคิวได้เลยครับ ผมบอกราคาให้ครบก่อนเริ่มงานเสมอ"
      />
    </>
  );
}
