      ...
      <section className="section" id="area">
        <div className="wrap">
          <div className="max-w-2xl">
            ...
            <h2 className="h2 mt-4">ผมวิ่งงานรัศมี 20 กม. รอบสันกำแพง</h2>
            <p className="lead mt-3">
              ผมรับงานในรัศมีประมาณ 20 กิโลเมตรจากบ้านผมที่สันกำแพง ครอบคลุม 8 อำเภอ
              ตั้งแต่สันกำแพง สารภี เมืองเชียงใหม่ ดอยสะเก็ด สันทราย หางดง แม่ริม ไปจนถึงแม่ออน
              ราคาเท่ากันทุกโซน ไม่บวกค่าเดินทางครับ
            </p>
          </div>
