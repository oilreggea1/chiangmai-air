        ...
        <div className="wrap relative grid gap-12 pt-12 pb-16 sm:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:pt-20 lg:pb-24">
          <div>
            ...
            <p className="lead mt-5 max-w-xl">
              ผมช่างอาร์ม ช่างผู้รับผิดชอบงานของโปรเฟรชแคร์ รับล้างแอร์ ซ่อมแอร์ ติดตั้ง
              และย้ายแอร์ทั่วเชียงใหม่ ผมแจ้งราคาให้ครบก่อนเริ่มงานทุกครั้ง ตรวจวัดน้ำยาให้ดูก่อนเติม
      ...
      <section className="section" id="services">
        <div className="wrap">
          <div className="max-w-2xl">
            ...
            <h2 className="h2 mt-4">ดูแลงานแอร์ครบทุกประเภท</h2>
            <p className="lead mt-3">
              ตั้งแต่การล้างประจำปี ซ่อมอาการเสีย ติดตั้งเครื่องใหม่ ไปจนถึงการย้ายแอร์
              ผมระบุราคาไว้ในแต่ละหน้าเพื่อให้พิจารณาได้ก่อนติดต่อ
            </p>
          </div>
      ...
      <section className="section" id="area">
        <div className="wrap">
          <div className="max-w-2xl">
            ...
            <p className="lead mt-3">
              ผมรับงานในรัศมีประมาณ 20 กิโลเมตรจากที่ตั้งในสันกำแพง ครอบคลุม 8 อำเภอ
              ได้แก่ สันกำแพง สารภี เมืองเชียงใหม่ ดอยสะเก็ด สันทราย หางดง แม่ริม และแม่ออน
