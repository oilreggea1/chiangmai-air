        ...
        <div className="wrap relative grid gap-12 pt-12 pb-16 sm:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:pt-20 lg:pb-24">
          <div>
            ...
            <p className="lead mt-5 max-w-xl">
              ...
              และล้างถังเครื่องซักผ้าทั่วเชียงใหม่ ผมแจ้งราคาให้ครบก่อนเริ่มงานทุกครั้ง ตรวจวัดน้ำยาให้ดูก่อนเติม
            ...
            {[
              {
                ...
                feats: ["ล้างฟิลเตอร์และหน้ากาก", "ล้างคอยล์เย็น–คอยล์ร้อน", "ฉีดล้างใบพัดกรงกระรอก", "3 เครื่องขึ้นไป เครื่องละ 550.-"],
              },
              {
